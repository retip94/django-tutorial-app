...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question_and_past_question(self):
        """
        Even if both past and future questions exist, only past question is displayed
        """
        create_question(question_text='Future question.', days=30)
        create_question(question_text='Past question.', days=-30)
        response = self.client.get(reverse('polls:index'))
    ...
    def test_two_past_questions(self):
        """
        The question index page may display multiplw questions
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail of the question with pub_date in the future returns 404
        """
...
class QuestionResultsViewTests(TestCase):
    def test_future_question(self):
        """
        The results of the question with pub_date in the future returns 404
        """
    ...
    def test_past_question(self):
        """
        The results of the question with pub_date in the past displays the question's text
        """
